...
static void enet_mac_dma_config(void)
{
    ...
    if(ERROR == reval_state){
		...
		enet_initpara_config(FILTER_OPTION, ENET_SRC_FILTER_DISABLE|ENET_DEST_FILTER_INVERSE_DISABLE|ENET_MULTICAST_FILTER_NONE|ENET_UNICAST_FILTER_PERFECT|ENET_PCFRM_FORWARD_ALL);
